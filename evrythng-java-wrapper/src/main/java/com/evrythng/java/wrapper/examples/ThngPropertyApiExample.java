...
public class ThngPropertyApiExample extends ExampleRunner {
	...
	protected void doRun() throws EvrythngException {
		...
		List<AbstractProperty<?>> results = thngService.propertiesCreator(thng.getId(), properties).execute();
		...
		Builder<List<AbstractProperty<?>>> thngPropertiesReader = thngService.propertiesReader(thng.getId());
		...
		Builder<List<AbstractProperty<?>>> temperatureReader = thngService.propertyReader(thng.getId(), "temperature");
		List<AbstractProperty<?>> values = temperatureReader.execute();
		...
		Builder<List<AbstractProperty<?>>> temperatureUpdater = thngService.propertyUpdater(thng.getId(), "temperature", String.valueOf(Math.random()));
		...
		Builder<List<AbstractProperty<?>>> speedReader = thngService.propertyReader(thng.getId(), "speed");
